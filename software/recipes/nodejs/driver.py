...
class PlatformDriver(ABC):
    ...
    def install_tarball(self, version: str, tarball: "Path") -> str:
        ...
        Linux/macOS: tar.xz / tar.gz 解压到版本目录
        Windows: zip 解压到版本目录
        """
        ...
    ...
    def install_shim(self, fallback_bin: str) -> None:
        """安装 shim（node/npm/npx wrapper）并注入 PATH"""
        ...
    ...
    def apply_version_link(self, bin_dir: str) -> None:
        """创建/更新系统 node 指向（symlink 或 junction 路由）"""
        ...

    @abstractmethod
    def restore_original(self) -> None:
        """卸载时清理系统 node 相关 PATH/symlink/junction"""
        ...

    @abstractmethod
    def detect_active(self) -> str | None:
        """检测当前活跃 Node.js 版本字符串，如 '22.11.0'"""
        ...
