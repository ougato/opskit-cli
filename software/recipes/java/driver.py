...
class PlatformDriver(ABC):
    ...
    def install_shim(self, fallback_bin: str) -> None:
        """安装 shim（java/javac/jar/javadoc/keytool wrapper）并注入 PATH"""
        ...
    ...
    def apply_version_link(self, bin_dir: str) -> None:
        """创建/更新系统 java 指向（symlink 或 junction 路由）"""
        ...

    @abstractmethod
    def restore_original(self) -> None:
        """卸载时清理系统 java 相关 PATH/symlink/junction"""
        ...

    @abstractmethod
    def detect_active(self) -> str | None:
        """检测当前活跃 JDK 版本字符串，如 '21.0.11+10'"""
        ...
