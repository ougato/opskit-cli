...
TAILSCALE_IP_VERSION_ARG = "-4"
TAILSCALE_HOST_SOURCE = "tailscale"
PUBLIC_HOST_SOURCE = "public"
CUSTOM_HOST_SOURCE = "custom"
...
TROJAN_CERT_FILE = XUI_CONFIG_DIR / "opskit-trojan.crt"
TROJAN_KEY_FILE = XUI_CONFIG_DIR / "opskit-trojan.key"
TROJAN_CERT_DAYS = 365
TROJAN_CERT_RSA_BITS = 2048
TROJAN_ALLOW_INSECURE = "1"
